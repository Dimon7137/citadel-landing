...
const features = [
  { icon: Cpu, title: "Modular architecture", description: "Two-component system adaptable to defect size and anatomy." },
  { icon: Shield, title: "Mechanical-axis support", description: "Intramedullary alignment for stable temporary fixation." },
  { icon: Layers, title: "PMMA spacer compatibility", description: "Designed to function with antibiotic-loaded spacers." },
  { icon: Activity, title: "HA-Ag antibacterial interface", description: "Selective coating in bone-contact zones." },
];
    ...
    <section id="solution" className="relative z-0 py-20 md:py-28 bg-white overflow-hidden">
      ...
      <div className="section-container relative z-10">
        <AnimatedSection>
          <SectionHeader
            label="The Solution"
            title={<>CITadel: a modular temporary{" "}<span className="text-teal-600">internal stabilisation system</span></>}
          />
        </AnimatedSection>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          ...
          {/* Right: Explained illustration */}
          <AnimatedSection direction="right">
            <div className="relative flex items-center justify-center">
              <img
                src="/citadel-landing/section4-nobg.png"
                alt="CITadel system — modular intramedullary fixator with annotations"
