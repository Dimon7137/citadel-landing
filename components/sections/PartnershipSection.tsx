...
const partnerships = [
  {
    ...
    description: "License the CITadel system for manufacturing and distribution within your product portfolio.",
  },
  {
    icon: GitBranch,
    title: "Co-development",
    description: "Joint engineering and regulatory pathway development towards CE/MDR compliance.",
  },
  {
    icon: Building2,
    title: "Clinical pilot sites",
    description: "Partner as a reference centre for structured clinical validation and pilot deployment.",
  },
  {
    icon: TrendingUp,
    title: "Strategic investment",
    description: "Accelerate transition to clinical-scale adoption through strategic funding.",
  },
];
    ...
    <section id="partnership" className="relative z-0 py-20 md:py-28 bg-[#0f172a] overflow-hidden">
      ...
      <div className="section-container relative z-10">
        <AnimatedSection>
          <SectionHeader
            label="Partnership"
            title={<>Partnership and{" "}<span className="text-teal-400">collaboration</span> opportunities</>}
            light
          />
        </AnimatedSection>
