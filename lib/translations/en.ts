export const en = {
  ...
  brand: {
    name: "CITadel",
    tagline: "Intramedullary System",
  },

  // CTA
  cta: {
    requestMeeting: "Request Meeting",
    downloadTeaser: "Download Teaser (PDF)",
  ...
  contact: {
    ...
    formSubtitle: "Describe your interest — we respond within one business day",
    nameLabel: "Name *",
    ...
    orgPlaceholder: "Company, hospital, university...",
    messagePlaceholder: "Describe your interest...",
    successTitle: "Message sent",
    successText: "We will get back to you within one business day.",
  },
  ...
  footer: {
    ...
    collaborationValue: "Partnership · Licensing · Co-development",
    copyright: "CITadel · Maksym Baida, PhD. All rights reserved.",
    institution: "Bogomolets National Medical University · Kyiv, Ukraine",
  },
};
