export const de = {
  ...
  brand: {
    name: "CITadel",
    tagline: "Intramedulläres System",
  },

  // CTA
  cta: {
    requestMeeting: "Meeting anfragen",
    downloadTeaser: "Teaser herunterladen (PDF)",
  ...
  contact: {
    label: "Kontakt",
    title: "Kontakt und",
    titleHighlight: "Anfragen",
    description: "CITadel ist offen für die Zusammenarbeit mit Industriepartnern, klinischen Zentren und strategischen Stakeholdern.",
    emailLabel: "E-Mail",
    phoneLabel: "Telefon",
    formTitle: "Senden Sie uns eine Nachricht",
    formSubtitle: "Beschreiben Sie Ihr Interesse — wir antworten innerhalb eines Werktages",
    nameLabel: "Name *",
  ...
  footer: {
    ...
    collaborationValue: "Partnerschaft · Lizenzierung · Gemeinsame Entwicklung",
    copyright: "CITadel · Maksym Baida, PhD. Alle Rechte vorbehalten.",
    institution: "Nationale Medizinische Universität Bogomolets · Kiew, Ukraine",
  },
};
